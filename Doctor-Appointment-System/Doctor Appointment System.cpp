...
{
    doctors[0] = { "DrAdrian", "Dentist", "adrian", "adrian1234", true };
    doctors[1] = { "DrFelix", "Gynecologist", "felix", "felix1234", true };
    doctors[2] = { "DrLiam", "Surgeon", "liam", "liam1234", true };

}

void initializeAppointments()
{
    appointments[0] = { "abc", "abc123@gmail.com", "DrAdrian", "10am" };
}
